...
namespace dsemi {
	...
	ecs_component_array::ecs_component_array()
	...
	ecs_component_array::ecs_component_array(const ecs_component_array& other)
	...
	ecs_component_array& ecs_component_array::operator=(const ecs_component_array& other)
	{
		if (_allocated)
			free(_allocated);
	...
	void ecs_component_array::insert(size_t entity_id, void* component) noexcept
	{
		grow(entity_id - 1);
	...
	void ecs_component_array::insert_new(size_t entity_id, void* component) noexcept
	{
		grow(entity_id - 1);
	...
	void ecs_component_array::remove(size_t entity_id) noexcept
	{
	...
	void ecs_component_array::grow(size_t num_elements) noexcept
	{
	...
	void* ecs_component_array::at(size_t entity_id) noexcept
	{
	...
	void* ecs_component_array::operator[] (size_t i) noexcept
	{
		return at(i);
	}
}
